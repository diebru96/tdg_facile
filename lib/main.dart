...
void main() {
  ...
  // Portrait mode – best for this tower-defense layout
  SystemChrome.setPreferredOrientations([DeviceOrientation.portraitUp]);
  SystemChrome.setEnabledSystemUIMode(SystemUiMode.immersiveSticky);
  runApp(const HomeDefenseApp());
}

class HomeDefenseApp extends StatelessWidget {
  const HomeDefenseApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(title: 'Home Defense', debugShowCheckedModeBanner: false, theme: ThemeData.dark(), home: const _GamePage());
  }
}
...
class _GamePageState extends State<_GamePage> {
  // Game instance lives here so it survives widget rebuilds
  late final HomeDefenseGame _game;

  @override
  void initState() {
    super.initState();
    _game = HomeDefenseGame();
  }
